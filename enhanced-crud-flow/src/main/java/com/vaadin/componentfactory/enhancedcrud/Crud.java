...
public class Crud<E> extends PolymerTemplate<TemplateModel> implements HasSize, HasTheme {
     ...
     * @see com.vaadin.componentfactory.enhancedcrud.Crud#Crud(Class, CrudEditor) Crud(Class, CrudEditor)
     */
     ...
     * @param editor the editor for manipulating individual items
     * @see CrudGrid
     * @see com.vaadin.componentfactory.enhancedcrud.Crud#Crud(Class, Grid, CrudEditor) Crud(Class, Grid, CrudEditor)
     */
